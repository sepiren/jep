...
echo $__Context->lang->email_address;
			...
			<?php if($__Context->colorset){ ?><input type="image" src="/widgets/login_info/skins/xe_official/images/<?php echo $__Context->colorset ?>/buttonLogin.gif" alt="login" class="login" /><?php } ?>
