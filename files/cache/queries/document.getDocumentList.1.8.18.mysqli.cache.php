...
${'s_email_address14_argument'} = new ConditionArgument('s_email_address', $args->s_email_address, 'like');
${'s_email_address14_argument'}->createConditionValue();
if(!${'s_email_address14_argument'}->isValid()) return ${'s_email_address14_argument'}->getErrorMessage();
} else
${'s_email_address14_argument'} = NULL;if(${'s_email_address14_argument'} !== null) ${'s_email_address14_argument'}->setColumnType('varchar');
...
,new ConditionWithArgument('`email_address`',$s_email_address14_argument,"like", 'or')
